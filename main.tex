...
实验的图~\ref{fig:lax_wendroff2} 和图~\ref{fig:lax_wendroff4} 和分析内容。
...
\begin{figure}[htpb]
	...
	\caption{较弱的慢激波。取 \(x_0 = 0.0，\) 使用 Upwind 和 TVD 格式。}%
	\label{fig:lax_wendroff2}
\end{figure}

\begin{figure}[htpb]
	\centering
	\includegraphics[width=\textwidth]{figures/case3_fast_upwind_TVD.pdf}
	\caption{较弱的慢激波。取 \(x_0 = 0.0，\) 使用 Upwind 和 TVD 格式。}%
	\label{fig:lax_wendroff2}
\end{figure}
...
\begin{figure}[htpb]
	...
	\caption{较弱的慢激波。取 \(x_0 = 0.0，\) 使用 Upwind 格和 TVD 式。}%
	\label{fig:lax_wendroff2}
\end{figure}
